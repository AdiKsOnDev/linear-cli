...
def search_issues(
    ...
    \b
    Search Examples:
        linearator search issues "authentication bug"
        linearator search issues "API timeout" --team ENG --priority 3
        linearator search issues "login" --assignee john@example.com --state "In Progress"
        linearator search issues "database" --labels "bug,high-priority" --limit 10
...
def search(
    ...
    See 'linearator search issues --help' for detailed usage information.
    """
